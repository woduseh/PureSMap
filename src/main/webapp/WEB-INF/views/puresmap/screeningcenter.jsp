...
<form>
	...
	<input type='button' value='Show Every Screening Centers' onclick="makeAllResult(size)" />
	<input type='button' value='Show closest Screening Centers' onclick="makeResult(size)" />
</form>
